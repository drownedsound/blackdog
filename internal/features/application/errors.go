...
var (
	...
	ErrMissingBirthday = errors.New("birthday is required")
	ErrBirthdayInFuture  = errors.New("birthday cannot be in the future")
	ErrMinimumAgeNotMet = errors.New("minimum age not met")
	...
	ErrMissingContactNumber = errors.New("contact number is required")
	ErrInvalidContactNumber = errors.New("contact number is not a valid value")
	...
	ErrMissingMemberRefNo = errors.New("member reference number is required")
	...
	ErrInsertFailed      = errors.New("database record insertion failed")
