...
-- ============================================================================
INSERT INTO REF_PRODUCT_CATEGORY (code, description) VALUES 
    ('CARD', 'Credit Card'),
    ('LOAN', 'Personal Loan');
...
INSERT INTO REF_PRODUCT_TYPE (code, description, category_code) VALUES 
    ('VISA_CLASSIC', 'Visa Classic Credit Card', 'CARD'),
    ('VISA_GOLD', 'Visa Gold Credit Card', 'CARD'),
    ('VISA_PLATINUM', 'Visa Platinum Rewards Card', 'CARD'),
    ('MC_STANDARD', 'Mastercard Standard', 'CARD'),
    ('MC_WORLD', 'Mastercard World Elite', 'CARD'),
    ('JCB_LUCKY', 'JCB Lucky Cat Rewards', 'CARD'); 
